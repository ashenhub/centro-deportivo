...
namespace CentroDeportivo
{
	public class Modelo
	{
        ...
        public void DatosMock()
        {
            ...
            listaUsuarios.Add(new Usuario("98327466B", "María", "Martínez Pérez", new DateTime(1988, 11, 03), false, "Femenino", a2, a1, a4));
            listaUsuarios.Add(new Usuario("12639913C", "Carlos", "Fernández Rodríguez", new DateTime(2002, 03, 15), true, "Masculino", a3, a2, a4));
        }
